...
- [ ] 02-03-PLAN.md — Staff account management (create/edit/deactivate, permission toggles)
- [ ] 02-04-PLAN.md — Package list: publish/unpublish, feature, drag-reorder, soft-delete

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 02-05-PLAN.md — Package create/edit form (Details/Itinerary/Inclusions & FAQ)
